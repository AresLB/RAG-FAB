    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-8">
              <Link href="/" className="text-xl font-semibold text-slate-900 dark:text-zinc-100 hover:text-slate-700 dark:hover:text-white transition-colors">
                Responobis
              </Link>
            </div>
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="rounded-lg px-4 py-2 text-sm font-medium text-slate-600 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-zinc-100 hover:bg-slate-100 dark:hover:bg-zinc-800/50 transition-colors"
              >
                Sign out
              </button>
            </div>
      ...
      <div className="flex pt-16">
        ...
        <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 md:pt-16">
          <div className="flex-1 flex flex-col min-h-0 border-r border-slate-200 dark:border-zinc-800/50 bg-white dark:bg-zinc-950">
